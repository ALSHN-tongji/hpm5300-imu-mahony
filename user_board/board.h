...
/* IMU INT pin (MPU6050 — PA31, falling edge) */
#define BOARD_IMU_INT_GPIO_CTRL  HPM_GPIO0
#define BOARD_IMU_INT_GPIO_INDEX GPIO_DI_GPIOA
#define BOARD_IMU_INT_GPIO_PIN   31
#define BOARD_IMU_INT_IRQ        IRQn_GPIO0_A
