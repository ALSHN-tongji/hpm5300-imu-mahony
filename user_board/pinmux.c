...
void init_imu_int_pin(void)
{
    HPM_IOC->PAD[IOC_PAD_PA31].FUNC_CTL = IOC_PA31_FUNC_CTL_GPIO_A_31;
    HPM_IOC->PAD[IOC_PAD_PA31].PAD_CTL = IOC_PAD_PAD_CTL_PE_SET(1) | IOC_PAD_PAD_CTL_PS_SET(1);
    gpio_set_pin_input(BOARD_IMU_INT_GPIO_CTRL, BOARD_IMU_INT_GPIO_INDEX, BOARD_IMU_INT_GPIO_PIN);
}
